...
fig_24(TD.output = out_TD, PD.output = out_PD, FD.output = out_FD, q = 0)

fig_24(TD.output = out_TD, PD.output = out_PD, FD.output = out_FD, q = 1)

fig_24(TD.output = out_TD, PD.output = out_PD, FD.output = out_FD, q = 2)
